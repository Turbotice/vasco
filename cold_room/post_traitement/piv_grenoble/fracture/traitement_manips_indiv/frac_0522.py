...
ind_sup_fit = 35
print(xvals)
fit_params = np.polyfit(xvals[ind_inf_fit:ind_sup_fit],v_converted_meters_1[frame_frac-i0,yind,ind_inf_fit:ind_sup_fit],2)
print(fit_params)

plt.figure()
plt.plot(xvals,v_converted_meters_1[frame_frac-i0,yind,:],label='frame '+str(i+i0))
